            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form-sample" method="POST" action="{{ route('suppliers.update', $supplier) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="name"
                                                value="{{ old('name') == null ? $supplier->name : old('name') }}" />
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="email"
                                                value="{{ old('email') == null ? $supplier->email : old('email') }}" />
                                            @if ($errors->has('email'))
                                                <label class="form-check-label text-danger"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="mobile" class="form-control"
                                                value="{{ old('mobile') == null ? $supplier->mobile : old('mobile') }}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="contact_name"
                                                value="{{ old('contact_name') == null ? $supplier->contact_person : old('contact_name') }}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="contact_mobile"
                                                value="{{ old('contact_mobile') == null ? $supplier->contact_mobile : old('contact_mobile') }}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="adrl1"class="form-control"
                                                value="{{ old('adrl1') == null ? $supplier->adr_ln1 : old('adrl1') }}" />
                                            @if ($errors->has('adrl1'))
                                                <label class="form-check-label text-danger"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="state" class="form-control"
                                                value="{{ old('state') == null ? $supplier->state : old('state') }}" />
                                            @if ($errors->has('state'))
                                                <label class="form-check-label text-danger"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="adrl2" class="form-control"
                                                value="{{ old('adrl2') == null ? $supplier->adr_ln2 : old('adrl2') }}" />
                                            @if ($errors->has('adrl2'))
                                                <label class="form-check-label text-danger"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pincode" class="form-control"
                                                value="{{ old('pincode') == null ? $supplier->pincode : old('pincode') }}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="city" class="form-control"
                                                value="{{ old('city') == null ? $supplier->city : old('city') }}" />
                                            @if ($errors->has('city'))
                                                <label class="form-check-label text-danger"
