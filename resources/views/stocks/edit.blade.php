                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <form class="forms-sample" method="POST" action="{{ route('stocks.update', $stock) }}">
                                @csrf
                                @method('put')
                                        ...
                                        <select class="form-control" name="medicine">
                                            ...
                                            @foreach ($medicines as $medicine)
                                                    <option value="{{ $medicine->id }}"
                                                        ...
                                                        @if ($stock->medicines_id == $medicine->id)
                                                        selected @endif
                                                        @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-11">
                                        <input type="number" name="quantity" class="form-control"
                                            value="{{ old('quantity') == null ? $stock->quantity : old('quantity') }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exp_date" data-date-format="dd/mm/yyyy"
                                        name="exp_date"
                                        value="{{ old('exp_date') == null ? date('d/m/Y', strtotime($stock->exp_date)) : old('exp_date') }}">
