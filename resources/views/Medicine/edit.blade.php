            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form-sample" method="POST" action="{{ route('medicines.update', $medicine) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="name"
                                                value="{{ old('name') == null ? $medicine->name : old('name') }}" />
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="brand"
                                                value="{{ old('brand') == null ? $medicine->brand : old('brand') }}" />
                                            @if ($errors->has('brand'))
                                                <label class="form-check-label text-danger"
                                            ...
                                            <select class="form-control" name="category">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        @if (old('role') == $category->id) selected @else 
                                                        @if ($medicine->medicine_category_id == $category->id)
                                                        selected @endif
                                                        @endif>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="content"
                                                value="{{ old('content') == null ? $medicine->content : old('content') }}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="amount" step=".01"
                                                value="{{ old('amount') == null ? $medicine->amount : old('amount') }}"
                                                inputmode="numeric" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="description">{{ old('description') == null ? $medicine->description : old('description') }} </textarea>
