    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Add Head Quarters</h4>
                        <div class="table-responsive">
                            <form class="forms-sample" method="POST" action="{{ route('hq.store') }}">
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputUsername1">Head Quarters Name</label>
                                    <input type="text" class="form-control" name="name" placeholder="Head Quarters name"
                                        required>
                                </div>
                                <div class="form-group">
